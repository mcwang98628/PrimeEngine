	...
	// start root
	{
		...
		// start root.CharacterControl
		{
			...
			// start root.CharacterControl.Events
			{
				...
				// Event_CreateEnemyNPC::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				SoldierNPCAnimSM_Event_STAND_AND_SHOOT::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				SoldierNPCMovementSM_Event_ENEMY_DETECTED::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
