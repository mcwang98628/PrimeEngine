...
struct SoldierNPCMovementSM_Event_ENEMY_DETECTED : public PE::Events::Event {
	PE_DECLARE_CLASS(SoldierNPCMovementSM_Event_ENEMY_DETECTED);

	SoldierNPCMovementSM_Event_ENEMY_DETECTED(PE::Components::SceneNode* enemyNode);
	PE::Components::SceneNode* m_enemyNode;
};
...
struct SoldierNPCMovementSM : public PE::Components::Component
{
	...
	//
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_SoldierNPCMovementSM_Event_ENEMY_DETECTED)
	virtual void do_SoldierNPCMovementSM_Event_ENEMY_DETECTED(PE::Events::Event *pEvt);
	//
