...
struct Event_CREATE_PHYSICAL_COMPONENT : public Event {
	PE_DECLARE_CLASS(Event_CREATE_PHYSICAL_COMPONENT);

	Event_CREATE_PHYSICAL_COMPONENT(int &threadOwnershipMask) :m_threadOwnershipMask(threadOwnershipMask)
	{

	}
	virtual ~Event_CREATE_PHYSICAL_COMPONENT(){}
...
struct Event_PRE_PHYSICS_UPDATE : public Event {
	PE_DECLARE_CLASS(Event_PRE_PHYSICS_UPDATE);
	virtual ~Event_PRE_PHYSICS_UPDATE(){}

	PrimitiveTypes::Float32 m_frameTime;
};
	
struct Event_POST_PHYSICS_UPDATE : public Event {
	PE_DECLARE_CLASS(Event_POST_PHYSICS_UPDATE);
	virtual ~Event_POST_PHYSICS_UPDATE(){}
